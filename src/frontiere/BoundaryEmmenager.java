...
public class BoundaryEmmenager {
	...
	private void emmenagerDruide(String nomVisiteur) {
		...
		int forceDruide = Clavier.entrerEntier(question);
		
		int effetPotionMin, effetPotionMax;
		do {	
			question = "Quelle est la force de potion la plus faible que vous produisez?";
			effetPotionMin = Clavier.entrerEntier(question);
			
			question = "Quelle est la force de potion la plus forte que vous produisez?";
